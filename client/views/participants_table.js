Template.participantsTable.helpers({
	participants: function() {
		return Participants.find({},{sort: {joined:-1}});
	}
});

Template.participantRow.helpers({
	...
	superUser: function() {
		...
		return new Handlebars.SafeString('<button class="btn btn-mini btn-super-user '+btnClass+'">'+btnText+'</span>');
	}
});

Template.participantRow.events({
