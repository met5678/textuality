...
Router.map(function() {
	this.route('screen',{
		...
		waitOn: function() {
			return Meteor.subscribe('feedTexts');
			return Meteor.subscribe('screenSettings');
			return Meteor.subscribe('leaderParticipants',10);
			return Meteor.subscribe('featuredText',ScreenSettings.findOne("featuredTextGroup"));
		}
	});
